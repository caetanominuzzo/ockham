...
namespace primeira.Editor
{
    public static class Message_en
    {
        ...
        public static string AddonLoadingError                                     = "There is an error loading addon '{0}'.";
        public static string EditorCreationError                                = "There is an error loading editor for file '{0}'.";
        public static string EditorMissingEditortHeaderAttribute                = "Missing EditorHeaderAttribute in '{0}' Class.";
